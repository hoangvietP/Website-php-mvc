     ...
     <div class="wrapper">
      ...
      <div class="container_fullwidth">
        <div class="container">
         ...
         $idnd = $_SESSION["idND"];
         $query = mysqli_query($conn,"SELECT tenND,diachi,email,sdt FROM nguoidung WHERE idND='$idnd' ");
                          ...
                          <div class="run-customer">
                            ...
                            <form action="" method="GET">
                              <div class="form-row">
                                ...
                                <input type="text" class="input namefild" name="ten" value="<?php echo $dulieu['tenND']; ?>">
                              </div>
                              <div class="form-row">
                                <label class="lebel-abs">
                                  Địa chỉ:
                                ...
                                <input type="text" class="input namefild" name="diachi" value="<?php echo $dulieu['diachi']; ?>">
                              </div>
                              <div class="form-row">
                                <label class="lebel-abs">
                                  SDT:
                                ...
                                <input type="text" class="input namefild" name="sdt" value="<?php echo $dulieu['sdt']; ?>">
                              </div>
                              <div class="form-row">
                                <label class="lebel-abs">
                                  Email:
                                </label>
                                <input type="text" class="input namefild" name="email" value="<?php echo $dulieu['email']; ?>">
                              </div>
                             <input type="submit" name="suatt" value="Sửa">
                            </form>
                          </div>
                        </div>
                      </div>
