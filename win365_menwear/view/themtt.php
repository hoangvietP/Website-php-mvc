                        ...
                        <div class="col-md-6 col-sm-6">
                          <div class="run-customer">
                            ...
                            <form action="" method="GET">
                              ...
                              <button type="submit" name="themtt" value="lưu">Lưu thông tin</button><br/>
                             
                             <strong style="color: red;">! <h6>Thêm tài khoản sẽ hữu ích hơn lần sau và nhận nhiều ưu đãi hơn</h6></strong>
                            </form>
                          </div>
                        </div>
                      </div>
